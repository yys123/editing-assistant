...
DEFAULT_CONFIG = {
    ...
    "deepseek_presence_penalty": None,
    "deepseek_frequency_penalty": None,
    "deepseek_response_format": "text",
    "deepseek_thinking_type": "disabled",
    "deepseek_reasoning_effort": "high",
    "deepseek_timeout_seconds": None,
...
def _base_text_config() -> dict:
    return {
        ...
        "deepseek_presence_penalty": getattr(settings, "deepseek_presence_penalty", 0),
        "deepseek_frequency_penalty": getattr(settings, "deepseek_frequency_penalty", 0),
        "deepseek_response_format": getattr(settings, "deepseek_response_format", "text"),
        "deepseek_thinking_type": getattr(settings, "deepseek_thinking_type", "disabled"),
        "deepseek_reasoning_effort": getattr(settings, "deepseek_reasoning_effort", "high"),
        "deepseek_timeout_seconds": getattr(settings, "deepseek_timeout_seconds", 60),
